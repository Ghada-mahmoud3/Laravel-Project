...
<div class="card mb-4 shadow-sm">
    <div class="card-body">
        ...
        <p><strong>Application Deadline:</strong> {{ \Carbon\Carbon::parse($job->application_deadline)->format('Y-m-d') }}</p>
    </div>
</div>
...
<form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data" class="mb-5">
    ...
    <div class="mb-3">
        ...
        <input type="file" name="resume" id="resume" class="form-control" required><br><br>
    </div>
